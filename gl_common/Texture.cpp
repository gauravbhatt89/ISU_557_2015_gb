...
string  GLMultiTexture::_glsl_names[4] = { "texture_background", "texture_foreground", "texture_foreground", "texture_blend"};
#endif
...
int GLMultiTexture::loadAndCreateTextures2(string path_and_file_texture_1, string path_and_file_texture_2, string path_and_file_texture_3)
{
