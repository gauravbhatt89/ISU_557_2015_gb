...
GLSphere2::GLSphere2(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
*/
void GLSphere2::setModelMatrix(glm::mat4& modelmatrix)
{
...
*/
void GLSphere2::enableNormalVectorRenderer(bool value)
{
...
*/
void GLSphere2::initVBONormals(void)
{
...
*/
void GLSphere2::initShader(void)
{
...
*/
void GLSphere2::initShaderNormal(void)
{
...
void GLSphere2::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
