...
GLSphere3::GLSphere3(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
*/
void GLSphere3::setModelMatrix(glm::mat4& modelmatrix)
{
...
*/
void GLSphere3::enableNormalVectorRenderer(bool value)
{
...
*/
void GLSphere3::initVBONormals(void)
{
...
*/
void GLSphere3::initShader(void)
{
...
*/
void GLSphere3::initShaderNormal(void)
{
...
void GLSphere3::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
