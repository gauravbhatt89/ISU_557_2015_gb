...
GLSphere4::GLSphere4(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
*/
void GLSphere4::setModelMatrix(glm::mat4& modelmatrix)
{
...
*/
void GLSphere4::enableNormalVectorRenderer(bool value)
{
...
*/
void GLSphere4::initVBONormals(void)
{
...
*/
void GLSphere4::initShader(void)
{
...
*/
void GLSphere4::initShaderNormal(void)
{
...
void GLSphere4::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
