...
unsigned int createPolygonModel(void)
{
	...
	float vertices1[3*117 + 72] = {	/*1st Triangle*/-2,0,0,-2,0,1,-1,0,1,
	...
	float color1[3*117 + 72] = {	1.000, 0.271, 0.000,1.000, 0.271, 0.000,1.000, 0.271, 0.000,
									1.000, 0.271, 0.000,1.000, 0.271, 0.000,1.000, 0.271, 0.000,
									1.000, 0.498, 0.314,1.000, 0.498, 0.314,1.000, 0.498, 0.314,
									1.000, 0.498, 0.314,1.000, 0.498, 0.314,1.000, 0.498, 0.314,
									1.000, 0.498, 0.314,1.000, 0.498, 0.314,1.000, 0.498, 0.314,
									1.000, 0.498, 0.314,1.000, 0.498, 0.314,1.000, 0.498, 0.314,
									1.000, 0.498, 0.314,1.000, 0.498, 0.314,1.000, 0.498, 0.314,
	...
	// vertices
	glBindBuffer(GL_ARRAY_BUFFER, vboID[0]); // Bind our Vertex Buffer Object
	glBufferData(GL_ARRAY_BUFFER, (3*117 + 72) * sizeof(GLfloat), vertices1, GL_STATIC_DRAW); // Set the size and data of our VBO and set it to STATIC_DRAW
	...
	//Color
	glBindBuffer(GL_ARRAY_BUFFER, vboID[1]); // Bind our second Vertex Buffer Object
	glBufferData(GL_ARRAY_BUFFER, (3*117 + 72) * sizeof(GLfloat), color1, GL_STATIC_DRAW); // Set the size and data of our VBO and set it to STATIC_DRAW
